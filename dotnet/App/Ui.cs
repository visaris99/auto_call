// UI 공용 헬퍼 — CRM 상태 라벨/색 매핑(ui/theme.py·badge.tsx와 동일), 결과 7종, 리스트 행 모델.
...
public static class Ui
{
    ...
    public static (Brush Bg, Brush Fg) StatusColors(string status) => status switch
    {
        ...
        "ASSIGNED" or "CALLBACK" => (Brush("#F6EFBE"), Brush("#161410")),
        _ => (Brush("#FAF8F2"), Brush("#211F1A")),
    };

    /// <summary>콜 결과 7종 (CRM CALL_RESULT_LABEL) + 단축키 1~7.</summary>
