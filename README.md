...
## 개발 (WSL/리눅스)
    ...
    TM_SERVER_URL=http://127.0.0.1:3002 TM_ADB=/bin/true my_env/bin/python main.py  # 앱 실행(가짜 CRM + 발신 no-op)
...
- 기본 서버 주소는 운영 CRM(`https://crm.milestone-sales.xyz`)으로 내장되어 있음
- 운영 CRM에 `/api/v1` 배포가 완료됐는지 확인: `curl https://crm.milestone-sales.xyz/api/v1/version`
